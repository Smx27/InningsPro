...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'accent-gradient':
          'linear-gradient(135deg, hsl(var(--primary) / 0.26), hsl(var(--primary) / 0.08) 45%, transparent 90%)',
      ...
      boxShadow: {
        'elevated-card':
          '0 20px 45px -22px hsl(var(--primary) / 0.35), 0 14px 30px -24px rgb(15 23 42 / 0.42)',
        'elevated-panel':
          '0 26px 64px -30px hsl(var(--primary) / 0.4), 0 20px 42px -30px rgb(15 23 42 / 0.55)',
        'elevated-float':
          '0 30px 90px -40px hsl(var(--primary) / 0.5), 0 24px 56px -36px rgb(15 23 42 / 0.58)',
        'glow-primary':
